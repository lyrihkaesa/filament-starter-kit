...
final class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'locale' => is_scalar($user->locale) ? (string) $user->locale : 'en',
            'timezone' => is_scalar($user->timezone) ? (string) $user->timezone : 'UTC',
            'theme' => is_scalar($user->theme) ? (string) $user->theme : 'system',
